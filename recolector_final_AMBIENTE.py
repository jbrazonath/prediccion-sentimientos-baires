...
# ==============================================================================
# CONFIGURACIÓN PARA DATASET DE AMBIENTE
# ==============================================================================
CUENTAS_ECOSISTEMA = [
    'BAAmbiente',
    'ibaistrocchi'
...
META_POR_CUENTA = 700
CSV_SALIDA = "dataset_recolectado_AMBIENTE.csv"
# ==============================================================================
...
def recolector_masivo_ambiente():
    client = tweepy.Client(bearer_token=BEARER_TOKEN, wait_on_rate_limit=True)
    ids_viejos = obtener_ids_existentes()
    
    print(f"🚀 INICIANDO RECOLECCIÓN AMBIENTE (Meta: >5000 registros)")
    print(f"📋 Ecosistema Ambiental: {len(CUENTAS_ECOSISTEMA)} cuentas")
